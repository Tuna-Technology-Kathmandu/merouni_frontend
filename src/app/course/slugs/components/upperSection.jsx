    ...
    <div className='flex flex-col items-center'>
      ...
      <div className='  bg-[#30AD8F] bg-opacity-10 text-black rounded-md flex flex-row  mb-8  items-center justify-center w-[1150px] h-[150px] p-8'>
        <div className=' flex flex-col items-center pr-14'>
          ...
          <p className='whitespace-nowrap'>4 Years</p>
        </div>
        ...
        <div className=' flex flex-col items-center pl-14'>
          ...
          <p className='whitespace-nowrap'>72 Hours</p>
        </div>
      </div>
      ...
      <div className='   bg-opacity-10 text-black rounded-md flex flex-col  mb-8    w-[1150px]  pt-10'>
        ...
        <p className='pt-6 leading-7 '>
          The BCA program under the faculties of humanities and social sciences
          of Tribhuvan University aims to produce skilled computer application
          users and developers. It spans four years, is divided into eight
          semesters, and is offered in {'>'}128 colleges with 4500 seats for
          enrollment. The medium of instruction and examination of BCA is
          English. Tribhuvan University has launched Bachelor of Computer
          Application (BCA) program from the academic year 2074/75. In the first
          phase, this program was launched in six (6) constituent campuses of
          Tribhuvan University and are allocated 35 seats each. The program runs
          on semester-system under the faculties of Humanities and Social
          Sciences.
        </p>

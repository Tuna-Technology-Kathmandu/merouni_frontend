      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8'>
        {college?.collegeFacility.map((item, index) => {
          return (
            <div
              key={index}
              className='group flex flex-col p-6 rounded-2xl bg-white border border-gray-100 shadow-[0_2px_15px_rgba(0,0,0,0.02)] hover:shadow-[0_8px_30px_rgba(0,0,0,0.05)] transition-all duration-300'
            >

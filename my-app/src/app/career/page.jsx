      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {careersData.pagination.totalPages > 1 && (
          <div className="mt-8 flex justify-center gap-2">
            {Array.from({ length: careersData.pagination.totalPages }, (_, i) => i + 1).map(
              (page) => (
                <Link
                  key={page}
        ...
        <div className="mt-4 text-center text-sm text-gray-600">
          Page {careersData.pagination.currentPage} of {careersData.pagination.totalPages} | Total
          entries: {careersData.pagination.totalCount}
        </div>
      </div>
      <Footer />
    </>

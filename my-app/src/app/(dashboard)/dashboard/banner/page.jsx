...
//             title: data.title,
//             gallery: {
//               small: uploadedFiles.small,
//               medium: uploadedFiles.medium,
//               large: uploadedFiles.large,
//             },
//           }
//         ],
//       };
...
//       console.log("banner data before submitting",bannerData)

//       if (editing) {
//         const response = await authFetch(
//           `${process.env.baseUrl}${process.env.version}/banner?id=${editId}`,
//           {
//             method,
//             headers: {
...
//       setEditing(false);
//       reset();
//       setUploadedFiles({ small: "", medium: "", large: "" });
...
//       setValue("collegeId", banner.college_id);

//       if (banner.college) {
//         setSelectedCollege(banner.college);
//         setValue("collegeSearch", banner.college.name);
//       }

//       const galleries = banner.banner_galleries || [];
//       const newUploadedFiles = {
//         small: galleries.find(g => g.size === "small")?.url || "",
//         medium: galleries.find(g => g.size === "medium")?.url || "",
//         large: galleries.find(g => g.size === "large")?.url || "",
//       };
...
//                     <span className="text-red-500">{errors.collegeSearch.message}</span>
//                   )}
...
//                         ))
//                       ) : (
//                         <div className="p-2 text-center text-gray-500">No colleges found</div>
//                       )}
//                     </div>
//                   )}
//                 </div>
...
//                         setUploadedFiles((prev) => ({ ...prev, small: url }));
//                       }}
//                       defaultPreview={uploadedFiles.small}
//                     />
//                   </div>
//                   <div>
//                     <FileUpload
...
//                       onUploadComplete={(url) => {
//                         setUploadedFiles((prev) => ({ ...prev, medium: url }));
//                       }}
//                       defaultPreview={uploadedFiles.medium}
//                     />
//                   </div>
//                   <div>
//                     <FileUpload
...
//                       onUploadComplete={(url) => {
//                         setUploadedFiles((prev) => ({ ...prev, large: url }));
//                       }}
//                       defaultPreview={uploadedFiles.large}
//                     />
//                   </div>
//                 </div>
//               </div>

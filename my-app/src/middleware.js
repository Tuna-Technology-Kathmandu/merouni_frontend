  ...
  if (token) {
    try {
      ...
      const rolePermissions = {
        ...
        subscriber: ["/dashboard", "/dashboard/results" , "/dashboard/profile"],
        teacher: ["/dashboard", "/dashboard/agent", "/dashboard/results" , "/dashboard/profile"],
        student: ["/dashboard", "/dashboard/results", "/dashboard/profile"],
        parent: ["/dashboard", "/dashboard/results" , "/dashboard/profile"],
